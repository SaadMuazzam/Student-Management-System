...
def open_main_window():
    global main, search_var, first_name_strvar, last_name_strvar, email_strvar, contact_strvar, gender_strvar, stream_strvar, rollNumber_strvar, tree, dob
    ...
    dobLabel=ctk.CTkLabel(FirstFrame,text="Date of Birth:",font=("Helvetica",20))
    dob=DateEntry(FirstFrame,font=("Helvetica",16),width=15)
    ...
    dobLabel.grid(row=1,column=4,padx=20,pady=20)
    dob.grid(row=1,column=5,padx=10,pady=20)
...
def login_window():
    ...
    password.grid(row=2, column=0, padx=40, pady=20)
    ...
    mybutton = ctk.CTkButton(frame, text="Login", command=validate_login, font=("Helvetica", 16), text_color="white")
